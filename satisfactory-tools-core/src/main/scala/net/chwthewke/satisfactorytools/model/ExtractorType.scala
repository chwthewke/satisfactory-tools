...
abstract sealed class ExtractorType( override val entryName: String, val dataKey: String ) extends EnumEntry
...
object ExtractorType extends Enum[ExtractorType] {
  ...
  final case object Miner             extends ExtractorType( "miner", "Miner" )
  final case object WaterPump         extends ExtractorType( "water-pump", waterExtractorClass.name )
  final case object OilPump           extends ExtractorType( "oil-pump", oilExtractorClass.name )
  final case object FrackingExtractor extends ExtractorType( "fracking", frackingExtractorClass.name )
