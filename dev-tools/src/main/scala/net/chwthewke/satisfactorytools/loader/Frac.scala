...
case class Frac( num: Long, denom: Long ) {
  def +( other: Frac ): Frac =
    Frac.reduced( num * other.denom + denom * other.num, denom * other.denom )

  def *( other: Frac ): Frac =
    Frac.reduced( num * other.num, denom * other.denom )

  def inverse: Frac = Frac( denom, num )

  def /( other: Frac ): Frac = this * other.inverse

  def *( l: Long ): Frac  = Frac( num * l, denom )
  def *:( l: Long ): Frac = Frac( num * l, denom )

  def /( l: Long ): Frac  = Frac( num, denom * l )
